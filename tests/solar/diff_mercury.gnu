...
plot 'tests/solar/result_yo8.dat' using 1:2 smooth csplines ls 1 title 'Йошиды', \
     'tests/solar/result_ms8.dat' using 1:2 smooth csplines ls 2 title 'ПК-8', \
     'tests/solar/result_rk4.dat' using 1:2 smooth csplines ls 3 title 'Рунге-Кутты', \
     'tests/solar/result_hermite.dat' using 1:2 smooth csplines ls 4 title 'Эрмита'
