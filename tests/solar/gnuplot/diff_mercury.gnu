...
plot 'output/solar/result_yo8.dat' using 1:2 smooth csplines ls 1 title 'Йошиды', \
     'output/solar/result_ms8.dat' using 1:2 smooth csplines ls 2 title 'ПК-8', \
     'output/solar/result_rk4.dat' using 1:2 smooth csplines ls 3 title 'Рунге-Кутты', \
     'output/solar/result_hermite.dat' using 1:2 smooth csplines ls 4 title 'Эрмита'
